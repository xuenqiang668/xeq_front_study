...
[手把手教你用 Node 实现 HTTP 协议（一）](https://juejin.cn/post/7428063738589200394)

[手把手教你用 Node 实现 HTTP 协议（二）](https://juejin.cn/post/7428127259288305715)介绍了如何解析 HTTP 请求报文，这一章我们来讲解如何进行报文的收发和 TCP 连接的建立。
