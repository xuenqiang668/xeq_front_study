...
上一章我们介绍了 [Axios 源码解读 —— request 篇](https://github.com/xuenqiang668/xeq_front_study/blob/main/packages/code-source/axios/1.Axios-source-request.md)，这一章我们来介绍 Axios 实际发起网络请求的部分吧，也就是 `dispatchRequest` 方法。

## dispatchRequest

这个方法定义也比较简单（如下图）

![alt text](https://github.com/xuenqiang668/xeq_front_study/blob/main/packages/code-source/axios/image-9.png)
...
![alt text](https://github.com/xuenqiang668/xeq_front_study/blob/main/packages/code-source/axios/image-10.png)
...
![alt text](https://github.com/xuenqiang668/xeq_front_study/blob/main/packages/code-source/axios/image-11.png)
...
![alt text](https://github.com/xuenqiang668/xeq_front_study/blob/main/packages/code-source/axios/image-12.png)
...
![alt text](https://github.com/xuenqiang668/xeq_front_study/blob/main/packages/code-source/axios/image-13.png)
...
![alt text](https://github.com/xuenqiang668/xeq_front_study/blob/main/packages/code-source/axios/image-14.png)
...
![alt text](https://github.com/xuenqiang668/xeq_front_study/blob/main/packages/code-source/axios/image-15.png)

首先是用 `buildFullPath` 方法拼接了完整的请求 `url`。（如下图）

![alt text](https://github.com/xuenqiang668/xeq_front_study/blob/main/packages/code-source/axios/image-16.png)
...
![alt text](https://github.com/xuenqiang668/xeq_front_study/blob/main/packages/code-source/axios/image-17.png)
...
![alt text](https://github.com/xuenqiang668/xeq_front_study/blob/main/packages/code-source/axios/image-18.png)
...
![alt text](https://github.com/xuenqiang668/xeq_front_study/blob/main/packages/code-source/axios/image-19.png)
...
![alt text](https://github.com/xuenqiang668/xeq_front_study/blob/main/packages/code-source/axios/image-20.png)
