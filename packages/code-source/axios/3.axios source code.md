...
- [Axios 源码解读 —— request 篇](https://github.com/xuenqiang668/xeq_front_study/blob/main/packages/code-source/axios/1.Axios-source-request.md)
- [Axios 源码解读 —— 网络请求篇](https://github.com/xuenqiang668/xeq_front_study/blob/main/packages/code-source/axios/2.Axios-source-network.md)

今天，我们将实现一个简易的 `Axios`，用于在 `Node` 端实现网络请求，并支持一些基础配置，比如 baseURL、url、请求方法、拦截器、取消请求...

本次实现所有的源码都放在 [这里](https://github.com/xuenqiang668/xeq_front_study/tree/main/packages/code-source/axios)，感兴趣的可以看看。
...
接下来，我们将对 `http:localhost:9000/list` 发起一个网络请求，将响应返回的数据输出在控制台。(express start)
...
![alt text](https://github.com/xuenqiang668/xeq_front_study/blob/main/packages/code-source/axios/image-21.png)
...
![alt text](https://github.com/xuenqiang668/xeq_front_study/blob/main/packages/code-source/axios/image-22.png)
...
![alt text](https://github.com/xuenqiang668/xeq_front_study/blob/main/packages/code-source/axios/image-23.png)
...
[源码地址](https://github.com/xuenqiang668/xeq_front_study/tree/main/packages/code-source/axios)
